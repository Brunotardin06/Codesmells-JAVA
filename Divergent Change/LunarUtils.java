public final class LunarUtils {
    ...
    public static LunarDate solar2Lunar(SolarDate solar) {
        ...
        int m = getBitInt(solar11, 4, 5);
        int d = getBitInt(solar11, 5, 0);
        long offset = solarToInt(solar.year(), solar.month(), solar.day()) - solarToInt(y, m, d);
        ...
        return new LunarDate(lunarY, lunarM, lunarD, isLeap);
    }

    private static int calcOffset(int monthInfo, LunarDate lunar, int leap) {
        int offset = 0;
        int limit = leap;
        if (!lunar.isLeap()) {
            limit = (lunar.month() <= leap || leap == 0) ? lunar.month() - 1 : lunar.month();
        }
        for (int i = 0; i < limit; i++) {
            offset += getBitInt(monthInfo, 1, 12 - i) == 1 ? 30 : 29;
        }
        return offset;
    }

    private static SolarDate intToSolar(long g) {
        ...
        return new SolarDate((int) y, month, day);
    }
    ...
    public record LunarDate(int year, int month, int day, boolean isLeap) { }
